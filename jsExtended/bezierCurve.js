...
function initBezierCurve(globals){
    ...
    function defineBeziPoint(dragList, beziList) {
        var distanceAll = 0.0;
        var i, co0, co1, co2, co3;
        for (i = 0; i < dragList.length - 1; i++) {
            co1 = dragList[i];
            co2 = dragList[i+1];
        ...
        co1 = dragList[index1];
        co2 = dragList[index2];
        co3 = dragList[dragList.length - 1];
    ...
    function defineSplinePoint(dragList,splineList) {
        var distanceAll = 0.0;
        var i, co0, co1, co2, co3, co4, co5, co6;
        for (i = 0; i < dragList.length - 1; i++) {
            co1 = dragList[i];
            co2 = dragList[i+1];
            distanceAll += dist(co1[0], co1[1], co2[0], co2[1]);
        ...
        co4 = dragList[index4];
        co5 = dragList[index5];
        co6 = dragList[dragList.length - 1];
